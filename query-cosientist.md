...
2. K-Z3 — 時間帯別発現率分布。午前帯 5/14 → 昼過ぎ〜午後開始帯 (run18–24) 4/7 →
   ...
   夕方帯は run71A (15:49, cold 7/20 多発型) / run76A (16:20, cold 8/20 多発型) と
   cold 単独クラスタ型の高濃度発現が 2 例 — 濃度 (7–8/20) は before 基準線級で
   warm 同時上振れを伴わない新パターン寄り。午前〜夕方帯通算 cold>0 は
   76 試行中 40 試行 (~53%)。
