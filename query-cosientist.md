...
rank (期待 gain × 確率, 2026-09-06 第89回):
...
3. K-Z3 — 時間帯別発現率分布。午前 ~36% / 昼 ~48–52% / 夕方 cold 単独クラスタ型
   ...
   対比も維持。15時台 n は 3 セット (run215 + run216×2) で確定度向上。
