...
rank (期待 gain × 確率, 2026-09-05 第42回):
...
3. K-Z3 — 時間帯別発現率分布。午前 ~36% / 昼 ~48–52% / 夕方 cold 単独クラスタ型
   ...
   裾を強化 — 深夜帯通算 cold>0 は 116 試行中 30 試行 (~25.9%)。traffic 最低帯でも ~30% 前後の発現率が維持され、深夜低頻度の
