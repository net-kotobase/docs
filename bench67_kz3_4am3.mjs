// bench67 — K-Z3 4時台 3 セット目 (run184A-C)
...
const SEARCH = "https://search.kotobase.net/search?q=bench67kz3";
...
const result = { purpose: "bench67 K-Z3 4時台 3 セット目 (run184A-C)", observedAt: new Date().toISOString(), runs: [] };
for (let r = 0; r < 3; r += 1) {
  const runs = [];
